...
--[[
I Fixed some small Errors Few lines ;D
Heres UI LIB Devs Credits
            ...
            function tab:AddSection(text, side, order)
                ...
                function section:AddBind(data)
                    ...
                    function bind:SetBind(keybind)
                        ...
                        if self.bind == Enum.KeyCode.Backspace then                                           --LOOOOL Devs Fr Made this part Error Ayoo wheres Nil Check :)
                            self.bind = 'none'
